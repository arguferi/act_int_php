                            ...
                            <div class="card-body pb-0">
                                <div class="pb-3 border-bottom mb-3">
                                    <div class="d-flex mb-3 flex-wrap align-items-end">
                                        <img class="rounded me-3" src="<?= base_url() ?>/public/administrator/images/contacts/pic11.jpg" width="40" alt="">
                                        <div>
                                ...
                                <div class="pb-3 border-bottom mb-3">
                                    <div class="d-flex mb-3 flex-wrap align-items-end">
                                        <img class="rounded me-3" src="<?= base_url() ?>/public/administrator/images/contacts/pic22.jpg" width="40" alt="">
                                        <div>
                                ...
                                <div class="pb-3 border-bottom mb-3">
                                    <div class="d-flex mb-3 flex-wrap align-items-end">
                                        <img class="rounded me-3" src="<?= base_url() ?>/public/administrator/images/contacts/pic33.jpg" width="40" alt="">
                                        <div>
                                    ...
                                    <p class="fs-14 mb-0">Friendly service Josh, Lunar and everyone at Just Property in Hastings deserved a big Thank You from us for moving us from Jakarta to Medan during the lockdown.
                                    </p>
                                </div>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <a href="javascript:void();" class="btn btn-primary btn-block">See More Reviews</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12 col-md-6">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    <div class="recent-customer me-3">
                                        <img src="<?= base_url() ?>/public/administrator/images/contacts/pic-111.jpg" width="50" alt="">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <div class="recent-customer me-3">
                                        <img src="<?= base_url() ?>/public/administrator/images/contacts/pic222.jpg" width="50" alt="">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <div class="recent-customer me-3">
                                        <img src="<?= base_url() ?>/public/administrator/images/contacts/pic-333.jpg" width="50" alt="">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <div class="recent-customer me-3">
                                        <img src="<?= base_url() ?>/public/administrator/images/contacts/pic444.jpg" width="50" alt="">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <div class="recent-customer me-3">
                                        <img src="<?= base_url() ?>/public/administrator/images/contacts/pic555.jpg" width="50" alt="">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="recent-customer me-3">
                                        <img src="<?= base_url() ?>/public/administrator/images/contacts/pic666.jpg" width="50" alt="">
                                    </div>
                                    <div>
