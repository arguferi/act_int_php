                     ...
                     <div class="profile-head">
                         ...
                         <div class="profile-info">
                             <div class="profile-photo">
                                 <img src="<?= base_url() ?>/public/administrator/images/profile/profile.png" class="img-fluid rounded-circle" alt="">
                             </div>
                             <div class="profile-details">
                                 ...
                                 <div class="profile-email px-2 pt-2">
                                     <h4 class="text-muted mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f29b9c949db2978a939f829e97dc919d9f">[email&#160;protected]</a></h4>
                                     <p>Email</p>
                                 </div>
                         ...
                         <div class="card">
                             <div class="card-body">
                                 <div class="profile-blog">
                                     ...
                                     <img src="<?= base_url() ?>/public/administrator/images/profile/1.jpg" alt="" class="img-fluid mt-4 mb-4 w-100">
                             ...
                             <div class="card-body">
                                 <div class="profile-interest">
                                     ...
                                     <div class="row mt-4 sp4" id="lightgallery">
                                         <a href="images/profile/2.jpg" data-exthumbimage="images/profile/2.jpg" data-src="<?= base_url() ?>/public/administrator/images/profile/2.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                             <img src="<?= base_url() ?>/public/administrator/images/profile/2.jpg" alt="" class="img-fluid">
                                         </a>
                                         <a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="<?= base_url() ?>/public/administrator/images/profile/3.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                             <img src="<?= base_url() ?>/public/administrator/images/profile/3.jpg" alt="" class="img-fluid">
                                         </a>
                                         <a href="images/profile/4.jpg" data-exthumbimage="images/profile/4.jpg" data-src="<?= base_url() ?>/public/administrator/images/profile/4.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                             <img src="<?= base_url() ?>/public/administrator/images/profile/4.jpg" alt="" class="img-fluid">
                                         </a>
                                         <a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="<?= base_url() ?>/public/administrator/images/profile/3.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                             <img src="<?= base_url() ?>/public/administrator/images/profile/3.jpg" alt="" class="img-fluid">
                                         </a>
                             ...
                             <div class="card-body">
                                 <div class="profile-news">
                                     ...
                                     <div class="media pt-3 pb-3">
                                         <img src="<?= base_url() ?>/public/administrator/images/profile/5.jpg" alt="image" class="me-3 rounded" width="75">
                                     ...
                                     <div class="media pt-3 pb-3">
                                         <img src="<?= base_url() ?>/public/administrator/images/profile/6.jpg" alt="image" class="me-3 rounded" width="75">
                                         <div class="media-body">
                                             <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                                             <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                         </div>
                                     ...
                                     <div class="media pt-3 pb-3">
                                         <img src="<?= base_url() ?>/public/administrator/images/profile/7.jpg" alt="image" class="me-3 rounded" width="75">
                                         <div class="media-body">
                                             <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                                             <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                         </div>
                         ...
                         <div class="profile-tab">
                             <div class="custom-tab-1">
                                 <ul class="nav nav-tabs">
                                     ...
                                     <li class="nav-item"><a href="#edit" data-bs-toggle="tab" class="nav-link">Edit</a>
                                     </li>
                                 </ul>
                                 <div class="tab-content">
                                     <div id="my-posts" class="tab-pane fade active show">
                                         <div class="my-post-content pt-3">
                                             ...
                                             <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                 <img src="<?= base_url() ?>/public/administrator/images/profile/8.jpg" alt="" class="img-fluid w-100 rounded">
                                             ...
                                             <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                 <img src="<?= base_url() ?>/public/administrator/images/profile/9.jpg" alt="" class="img-fluid w-100 rounded">
                                                 <a class="post-title" href="post-details.html">
                                                     <h3 class="text-black">Collection of textile samples lay spread</h3>
                                                 </a>
                                                 <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                     ...
                                     <div id="about-me" class="tab-pane fade">
                                         ...
                                         <div class="profile-personal-info">
                                             ...
                                             <div class="row mb-2">
                                                 ...
                                                 <div class="col-sm-9 col-7"><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f89d80999588949db89d80999588949d94d69b9795">[email&#160;protected]</a></span>
                                                 </div>
                                             </div>
                                             <div class="row mb-2">
                                                 <div class="col-sm-3 col-5">
                                     ...
                                     <!-- arreglar el update la ruta no trabaja con post -->
                                     <div id="edit" class="tab-pane fade">
                                         <div class="pt-3">
                                             <div class="settings-form">
                                                 <h4 class="text-primary">Account Setting</h4>
                                                 <form action="/administrator/user/<?= $user->id ?>" method="POST">
                                                     ...
                                                     <div class="row">
                                                         <div class="mb-3 col-md-6">
                                                             ...
                                                             <select name="type" class="default-select form-control wide mb-3">
                                                                 ...
                                                                 <option <?= $user->type == 'superuser' ? 'selected' : '' ?> value="superuser">Super User</option>
                                                                 <option <?= $user->type == 'it' ? 'selected' : '' ?> value="it">IT</option>
                                                             </select>
