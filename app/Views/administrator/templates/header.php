...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="<?= base_url() ?>/public/administrator/images/favicon.png" />
    <link href="<?= base_url() ?>/public/administrator/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
    <link rel="stylesheet" href="<?= base_url() ?>/public/administrator/vendor/dotted-map/css/contrib/jquery.smallipop-0.3.0.min.css" type="text/css" media="all" />
    <!-- Style css -->
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?= base_url() ?>/public/administrator/images/avatar/1.jpg" class="rounded-circle user_img" alt="" />
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?= base_url() ?>/public/administrator/images/avatar/2.jpg" class="rounded-circle user_img" alt="" />
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?= base_url() ?>/public/administrator/images/avatar/3.jpg" class="rounded-circle user_img" alt="" />
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?= base_url() ?>/public/administrator/images/avatar/4.jpg" class="rounded-circle user_img" alt="" />
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?= base_url() ?>/public/administrator/images/avatar/5.jpg" class="rounded-circle user_img" alt="" />
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                            ...
                            <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
                                        <img src="<?= base_url() ?>/public/administrator/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="" />
                                    </div>
                                ...
                                <div class="d-flex justify-content-end mb-4">
                                    ...
                                    <div class="img_cont_msg">
                                        <img src="<?= base_url() ?>/public/administrator/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="" />
                                    </div>
                                </div>
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="me-5 agenda">
                                <a href="javascript:void(0);" class="btn btn-primary"><i class="fas fa-calendar"></i>Agenda (24)</a>
                            </div>
                            <div class="nav-item">
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media me-2">
                                                        <img alt="image" width="50" src="<?= base_url() ?>/public/administrator/images/avatar/1.jpg">
                                                    </div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <div class="header-info me-3">
                                        <span class="fs-18 font-w500 text-end"><?= $session->username ?></span>
                                        <small class="text-end fs-14 font-w400"><span class="__cf_email__" data-cfemail="21534e434453554e4240534d4e5b614c40484d0f424e4c">[email&#160;protected]</span></small>
                                    </div>
                                    <img src="<?= base_url() ?>/public/administrator/images/profile/pic1.jpg" width="20" alt="" />
                                </a>

                                <div class="dropdown-menu dropdown-menu-end">
                                    <form class="dropdown-item ai-icon">
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="<?= base_url() ?>/user">Ver todos los usuarios</a></li>
                            <li><a href="<?= base_url() ?>/user/new">Agregar usuarios</a></li>
                ...
                <div class="plus-box">
                    <p class="fs-14 font-w600 mb-2">Generata monthly <br>report more easier <br>than before</p>
                    <a class="btn btn-light btn-sm fs-14 text-black" href="javascript:void(0);">Learn more</a>
                </div>
                <div class="copyright">
                    <p><strong>Griya Real Estate Admin</strong> © 2021 All Rights Reserved</p>
