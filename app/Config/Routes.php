...
$routes->post('/login_post', 'Credentials::loginPost');
$routes->post('/logout', 'Credentials::logout');


$routes->group('administrator', static function ($routes) {
    // $routes->get('index', 'Administrator\index::index');
    $routes->get('index', 'Administrator::index');
    // $routes->post('user/(:num)', 'User::update/$1');
    $routes->post('user/(:any)/undelete', 'User::undelete/$1');
