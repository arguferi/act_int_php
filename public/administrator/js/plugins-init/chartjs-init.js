 ...
 var dzSparkLine = function(){
					...
					datasets: [
						{
							...
							borderColor: 'rgba(33, 111, 237, 1)',
							borderWidth: "0",
							backgroundColor: 'rgba(33, 111, 237, 1)'
						}
					]
				},
				options: {
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(33, 111, 237, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(33, 111, 237, 0.5)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(33, 111, 237, 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(33, 111, 237, 0.5)");
					...
					datasets: [
						{
							...
							pointBackgroundColor: 'rgba(33, 111, 237, 1)'
						}
					]
				},
				options: {
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(33, 111, 237, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(33, 111, 237, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(33, 111, 237, 0.5)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(33, 111, 237, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(33, 111, 237, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "1",
							backgroundColor: 'rgba(33, 111, 237, .5)', 
